...
// images
import PlaneWhiteLogo from "public/octek-logos/white-horizontal.png";
...
const TOUR_STEPS: {
...
}[] = [
  {
    ...
    description:
      "The issue is the building block of the Octek. Most concepts in Octek are either associated with issues and their properties.",
    image: IssuesTour,
    nextStep: "cycles",
  },
  {
        ...
        <div className="w-4/5 md:w-1/2 lg:w-2/5 h-3/4 bg-custom-background-100 rounded-[10px] overflow-hidden">
          <div className="h-full overflow-hidden">
            <div className="h-3/5 bg-custom-primary-100 grid place-items-center">
              <Image src={PlaneWhiteLogo} alt="Octek White Logo" />
            </div>
            <div className="h-2/5 overflow-y-auto p-6">
              <h3 className="font-semibold sm:text-xl">
                Welcome to Octek, {user?.first_name} {user?.last_name}
              </h3>
              <p className="text-custom-text-200 text-sm mt-3">
                We{"'"}re glad that you decided to try out Octek. You can now manage your projects
