...
const integrationDetails: { [key: string]: any } = {
  github: {
    ...
    notInstalled: "Connect with GitHub with your Octek workspace to sync project issues.",
  },
  slack: {
    logo: SlackLogo,
    installed: "Activate Slack on individual projects to sync with specific channels.",
    notInstalled: "Connect with Slack with your Octek workspace to sync project issues.",
  },
};
